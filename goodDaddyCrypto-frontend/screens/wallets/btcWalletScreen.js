      ...
      Le graphique doit afficher l'évolution du portefeuille dans le temps en fonction de amount of token et price$*/}
          ...
          <Card.Title style={{ color: "white",fontSize:20 }}>
            ...
            <View style={{alignItems:"center" }}>
              <Text style={{color: "#00B295", fontSize:25,  fontWeight:"bold" }}>{totalInvestmentAsset * showprice} €</Text>
              <Text style={{color: "#00B295", fontSize:25,  fontWeight:"bold" }}> {totalInvestmentAsset} {assetSymbol}</Text>
            </View>
          </Card>
        </View>
      </LinearGradient>
